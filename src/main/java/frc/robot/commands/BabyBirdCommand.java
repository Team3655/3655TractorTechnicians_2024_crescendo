...
public class BabyBirdCommand extends Command {
  ...
  public BabyBirdCommand(ShooterSubsystem shooter, IntakeSubsystem intake) {
  ...
  public void initialize() {
    shooter.requestState(ShooterTargets.BABY_BIRD);
  ...
  public boolean isFinished() {
    return intake.getIndexDistanceMM() <= 200;
  }
}
