...
/**
 * Implementation of the gyroscope class. Uses the Pigeon2 gyroscope to receive data about the
 * robots yaw, pitch, and roll values.
 */
public class GyroIOPigeon2 implements GyroIO {

  /**
   * Pigeon2 gyroscope object. Receives direct data from the gyroscope about the yaw, pitch, and
   * roll.
   */
