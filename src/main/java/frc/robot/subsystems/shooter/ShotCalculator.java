 ...
 */
public class ShotCalculator extends GeomUtil {
  ...
  public static ShotData calculate(
    ...
    // Get velocity of the robot reletive to the speaker
    ...
    Rotation2d goalHeading =
        GeomUtil.inverse(GeomUtil.toPose2d(robot))
            .transformBy(GeomUtil.toTransform2d(speaker))
            .getTranslation()
            .getAngle();
